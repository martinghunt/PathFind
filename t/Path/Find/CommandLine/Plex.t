...
# test 1
@args = ( '--test' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
...
# test 6
@args = ( '--test', '-i', 'invalid_value', '-tag', '3' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
throws_ok {$obj->run} 'Path::Find::Exception::InvalidInput', 'correct error thrown';
...
# test 12
@args = ( '--test', '-t', 'study', '-i', 'invalid_value', '-tag', '3' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
throws_ok {$obj->run} 'Path::Find::Exception::InvalidInput', 'correct error thrown';
...
# test 14
@args = ( '--test', '-t', 'lane', '-tag', '3' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
throws_ok {$obj->run} 'Path::Find::Exception::InvalidInput', 'correct error thrown';

# test 15
@args = ( '--test', '-t', 'lane', '-i', '6578_4' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
...
# test 16
@args = ( '--test', '-t', 'lane', '-i', '6578_4', '-tag', '3' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
...
# test 18
@args = ( '--test', '-t', 'lane', '-i', 'invalid_value', '-tag', '3' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
throws_ok {$obj->run} 'Path::Find::Exception::NoMatches', 'correct error thrown';

# test 19
@args = ( '--test', '-t', 'lane', '-i', '6578_4', '-h', 'yes' );
$obj = Path::Find::CommandLine::Plex->new(args => \@args, script_name => 'plexfind');
throws_ok {$obj->run} 'Path::Find::Exception::InvalidInput', 'correct error thrown';
